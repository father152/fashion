  ...
  return (
    <div>
      <News
        ...
        description="Якщо ви не можете знайти нову функцію або хочете поділитися своєю думкою про функції Google Фото, надішліть нам відгук. На жаль, ми не можемо відповісти на кожен відгук. Якщо у вас серйозніша проблема або ви хочете повідомити про порушення, дізнайтеся, як поскаржитися
