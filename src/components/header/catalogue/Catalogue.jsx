    ...
    <div className="catalogue">
      ...
      <div className="product">
        ...
        <Card
          brand="Ford"
          name="Auto"
            image={"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQtbgj0V4Z3lw5DmTmh60MSVo3jIExi2rSl5g&usqp=CAU"} 
            names='Picture 2'  
          model="Focus"
          description="dfgergeg ergdfgerg ergergerg ghjuighj 
        fghjrthdh thdghdh "
        ...
        <Card
          brand="Ford"
          name="Auto"
          image={"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR2rh5cFRzQ9DPEHZYlKO-gznuz6BB7_6LmVw&usqp=CAU"} 
            names='Picture 3'  
          model="Focus"
          description="dfgergeg ergdfgerg ergergerg ghjuighj 
        fghjrthdh thdghdh "
     ...
     brand="WEST"
     name="Jacket"
     image={"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQxuH8PntHVIli7ufhiPVnoeE6QC92Ge6Ek7Q&usqp=CAU"} 
     names='Picture 4'  
     model="Style"
     description="dfgergeg ergdfgerg ergergerg ghjuighj 
   fghjrthdh thdghdh "
